...
do
	...
	python /home/shaopengliu/pipe_script/github/ATAC-seq_QC_analysis/pipe_code/rpkm_bin.py merged_all.narrowPeak temp 10
...
Rscript /home/shaopengliu/pipe_script/github/ATAC-seq_QC_analysis/pipe_code/DOR_analysis.R $group1 $group2 $num1 $num2