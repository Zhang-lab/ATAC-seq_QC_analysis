...
if(max(saturate$percentage)<=1) {
	plot+scale_y_continuous(name="Percentage of recaptured peaks in original peaks",limits=c(0,100))
} else {
	plot+scale_y_continuous(name="Percentage of recaptured peaks in original peaks")
}
dev.off()
