...
autosome$V3=round(autosome$V3/map[,7],4)*100
...
if(genome!="danRer10") {
  part5=data.frame(round(as.numeric(args[10]),4)*100,round(chr[which(chr[,1]=='chrX'),3]/map[,7],4)*100,round(chr[which(chr[,1]=='chrY'),3]/map[,7],4)*100,autosome)
